...
)
{
  ...
  K___uint64_t_uint64_t_uint64_t_uint64_t
  out5 = { .fst = o05, .snd = o15, .thd = o21, .f3 = o31 };
  uint64_t c31 = h31 + c22;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t scrut7 = { .fst = c31, .snd = out5 };
  uint64_t c8 = scrut7.fst;
  K___uint64_t_uint64_t_uint64_t_uint64_t out010 = scrut7.snd;
  uint64_t o06 = out010.fst;
  uint64_t o16 = out010.snd;
  uint64_t o26 = out010.thd;
  uint64_t o32 = out010.f3;
  uint64_t f300 = o01;
  uint64_t f310 = o02;
  uint64_t f320 = o03;
  uint64_t f330 = c02;
  ...
  uint64_t o38 = scrut15.fst;
  uint64_t c24 = scrut15.snd;
  K___uint64_t_uint64_t_uint64_t_uint64_t
  out7 = { .fst = o07, .snd = o17, .thd = o27, .f3 = o38 };
  uint64_t c33 = h32 + c24;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t scrut16 = { .fst = c33, .snd = out7 };
  uint64_t c9 = scrut16.fst;
  K___uint64_t_uint64_t_uint64_t_uint64_t out011 = scrut16.snd;
  uint64_t o08 = out011.fst;
  uint64_t o18 = out011.snd;
  uint64_t o28 = out011.thd;
  uint64_t o39 = out011.f3;
  uint64_t f301 = o12;
  uint64_t f311 = o13;
  uint64_t f321 = o14;
  uint64_t f331 = c14;
  ...
  K___uint64_t_uint64_t scrut20 = Hacl_Spec_P256_Basic_addcarry(f331, o39, c25);
  uint64_t o3_0 = scrut20.fst;
  uint64_t c34 = scrut20.snd;
  K___uint64_t_uint64_t_uint64_t_uint64_t
  out8 = { .fst = o0_0, .snd = o1_0, .thd = o2_0, .f3 = o3_0 };
  uint64_t c41 = c9 + c34;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t scrut21 = { .fst = c41, .snd = out8 };
  uint64_t c26 = scrut21.fst;
  K___uint64_t_uint64_t_uint64_t_uint64_t out2 = scrut21.snd;
  uint64_t o22 = out2.fst;
  uint64_t o23 = out2.snd;
  uint64_t o24 = out2.thd;
  uint64_t o25 = out2.f3;
  uint128_t res12 = (uint128_t)b0 * f34;
  uint64_t l03 = (uint64_t)res12;
  uint64_t h013 = (uint64_t)(res12 >> (uint32_t)64U);
  uint128_t res13 = (uint128_t)b1 * f34;
  uint64_t l13 = (uint64_t)res13;
  uint64_t h13 = (uint64_t)(res13 >> (uint32_t)64U);
  uint128_t res14 = (uint128_t)b2 * f34;
  uint64_t l23 = (uint64_t)res14;
  uint64_t h23 = (uint64_t)(res14 >> (uint32_t)64U);
  uint128_t res15 = (uint128_t)b3 * f34;
  ...
  uint64_t o310 = scrut24.fst;
  uint64_t c210 = scrut24.snd;
  K___uint64_t_uint64_t_uint64_t_uint64_t
  out9 = { .fst = o09, .snd = o19, .thd = o29, .f3 = o310 };
  uint64_t c35 = h33 + c210;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t scrut25 = { .fst = c35, .snd = out9 };
  uint64_t c15 = scrut25.fst;
  K___uint64_t_uint64_t_uint64_t_uint64_t out01 = scrut25.snd;
  uint64_t o010 = out01.fst;
  uint64_t o110 = out01.snd;
  uint64_t o210 = out01.thd;
  uint64_t o311 = out01.f3;
  uint64_t f30 = o23;
  uint64_t f31 = o24;
  uint64_t f32 = o25;
  uint64_t f33 = c26;
  ...
  K___uint64_t_uint64_t scrut29 = Hacl_Spec_P256_Basic_addcarry(f33, o311, c21);
  uint64_t o3_1 = scrut29.fst;
  uint64_t c36 = scrut29.snd;
  K___uint64_t_uint64_t_uint64_t_uint64_t
  out10 = { .fst = o0_1, .snd = o1_1, .thd = o2_1, .f3 = o3_1 };
  uint64_t c42 = c15 + c36;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t scrut30 = { .fst = c42, .snd = out10 };
  uint64_t c37 = scrut30.fst;
  K___uint64_t_uint64_t_uint64_t_uint64_t out3 = scrut30.snd;
  ...
  K___uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t
  scrut31 =
    { .fst = o00, .snd = o11, .thd = o22, .f3 = o33, .f4 = o34, .f5 = o35, .f6 = o36, .f7 = o37 };
  ...
  uint64_t o312 = scrut34.fst;
  uint64_t c27 = scrut34.snd;
  K___uint64_t_uint64_t_uint64_t_uint64_t
  out11 = { .fst = o011, .snd = o111, .thd = o211, .f3 = o312 };
  uint64_t c38 = h34 + c27;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t scrut35 = { .fst = c38, .snd = out11 };
  uint64_t f35 = scrut35.snd.f3;
  uint64_t f21 = scrut35.snd.thd;
  uint64_t f11 = scrut35.snd.snd;
  uint64_t f01 = scrut35.snd.fst;
  uint64_t c17 = scrut35.fst;
  K___uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t
  scrut36 =
    {
      .fst = f01, .snd = f11, .thd = f21, .f3 = f35, .f4 = c17, .f5 = (uint64_t)0U,
  ...
  uint64_t o313 = scrut40.fst;
  uint64_t c39 = scrut40.snd;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t
  scrut41 = { .fst = c39, .snd = { .fst = o012, .snd = o112, .thd = o212, .f3 = o313 } };
  uint64_t o314 = scrut41.snd.f3;
  ...
  scrut46 =
    {
      .fst = c70, .snd = o013, .thd = o113, .f3 = o213, .f4 = o314, .f5 = o40, .f6 = o50, .f7 = o60,
      .f8 = o70
    };
  ...
  uint64_t o315 = scrut50.fst;
  uint64_t c29 = scrut50.snd;
  K___uint64_t_uint64_t_uint64_t_uint64_t
  out12 = { .fst = o014, .snd = o114, .thd = o214, .f3 = o315 };
  uint64_t c311 = h35 + c29;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t scrut51 = { .fst = c311, .snd = out12 };
  uint64_t f36 = scrut51.snd.f3;
  uint64_t f22 = scrut51.snd.thd;
  uint64_t f12 = scrut51.snd.snd;
  uint64_t f02 = scrut51.snd.fst;
  uint64_t c44 = scrut51.fst;
  K___uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t
  scrut52 =
    {
      .fst = f02, .snd = f12, .thd = f22, .f3 = f36, .f4 = c44, .f5 = (uint64_t)0U,
      .f6 = (uint64_t)0U, .f7 = (uint64_t)0U
    };
  ...
  uint64_t o316 = scrut56.fst;
  uint64_t c312 = scrut56.snd;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t
  scrut57 = { .fst = c312, .snd = { .fst = o015, .snd = o115, .thd = o215, .f3 = o316 } };
  uint64_t o317 = scrut57.snd.f3;
  ...
  scrut62 =
    {
      .fst = c71, .snd = o016, .thd = o116, .f3 = o216, .f4 = o317, .f5 = o41, .f6 = o51, .f7 = o61,
      .f8 = o71
    };
  ...
  uint64_t o318 = scrut67.fst;
  uint64_t c212 = scrut67.snd;
  K___uint64_t_uint64_t_uint64_t_uint64_t
  out13 = { .fst = o017, .snd = o117, .thd = o217, .f3 = o318 };
  uint64_t c314 = h36 + c212;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t scrut68 = { .fst = c314, .snd = out13 };
  uint64_t f37 = scrut68.snd.f3;
  uint64_t f23 = scrut68.snd.thd;
  uint64_t f13 = scrut68.snd.snd;
  uint64_t f03 = scrut68.snd.fst;
  uint64_t c46 = scrut68.fst;
  K___uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t_uint64_t
  scrut69 =
    {
      .fst = f03, .snd = f13, .thd = f23, .f3 = f37, .f4 = c46, .f5 = (uint64_t)0U,
      .f6 = (uint64_t)0U, .f7 = (uint64_t)0U
    };
  ...
  uint64_t o319 = scrut73.fst;
  uint64_t c315 = scrut73.snd;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t
  scrut74 = { .fst = c315, .snd = { .fst = o018, .snd = o118, .thd = o218, .f3 = o319 } };
  uint64_t o320 = scrut74.snd.f3;
  ...
  scrut79 =
    {
      .fst = c72, .snd = o019, .thd = o119, .f3 = o219, .f4 = o320, .f5 = o42, .f6 = o52, .f7 = o62,
      .f8 = o72
    };
  ...
  uint64_t o321 = scrut84.fst;
  uint64_t c214 = scrut84.snd;
  K___uint64_t_uint64_t_uint64_t_uint64_t
  out = { .fst = o020, .snd = o120, .thd = o220, .f3 = o321 };
  uint64_t c317 = h3 + c214;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t scrut85 = { .fst = c317, .snd = out };
  ...
  uint64_t o322 = scrut89.fst;
  uint64_t c318 = scrut89.snd;
  K___uint64_t_K___uint64_t_uint64_t_uint64_t_uint64_t
  scrut90 = { .fst = c318, .snd = { .fst = o021, .snd = o121, .thd = o221, .f3 = o322 } };
...
static void Hacl_Impl_LowLevel_reduction_prime_2prime_impl(uint64_t *x, uint64_t *result)
{
  ...
  uint64_t c = Hacl_Impl_LowLevel_sub4_il(x, Hacl_Impl_LowLevel_prime_buffer, tempBuffer);
...
static void Hacl_Impl_LowLevel_p256_add(uint64_t *arg1, uint64_t *arg2, uint64_t *out)
{
  ...
  uint64_t c = Hacl_Impl_LowLevel_sub4_il(out, Hacl_Impl_LowLevel_prime_buffer, tempBuffer);
...
static void fromDomain(uint64_t *f, uint64_t *result)
{
  ...
  uint64_t prim2 = (uint64_t)0U;
  uint64_t prim3 = (uint64_t)0xffffffff00000001U;
  uint64_t f00 = (uint64_t)1U;
  uint64_t f10 = (uint64_t)0U;
  uint64_t f20 = (uint64_t)0U;
  uint64_t f34 = (uint64_t)0U;
  uint128_t res0 = (uint128_t)b0 * f00;
  uint64_t l00 = (uint64_t)res0;
...
static void y_2(uint64_t *y, uint64_t *r)
{
  uint64_t multBuffer[8U] = { 0U };
  Hacl_Impl_LowLevel_shift_256_impl(y, multBuffer);
  Hacl_Impl_SolinasReduction_solinas_reduction_impl(multBuffer, r);
  Hacl_Spec_P256_MontgomeryMultiplication_montgomery_multiplication_buffer(r, r, r);
}

static void upload_p256_point_on_curve_constant(uint64_t *x)
{
  
}

static void xcube_minus_x(uint64_t *x, uint64_t *r)
{
  ...
  Hacl_Impl_LowLevel_p256_sub(r, minusThreeXBuffer, r);
  upload_p256_point_on_curve_constant(p256_constant);
  Hacl_Impl_LowLevel_p256_sub(r, p256_constant, r);
}
...
bool isPointOnCurve(uint64_t *p)
{
  ...
  uint64_t r = compare_felem((uint64_t *)(void *)(uint8_t)0U, (uint64_t *)(void *)(uint8_t)0U);
  bool r1 = r == (uint64_t)0U;
  return r1;
}
