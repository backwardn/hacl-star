...
static uint64_t Hacl_Impl_LowLevel_sub4_il(uint64_t *x, uint64_t *y, uint64_t *result)
{
  uint64_t *r0 = result;
...
extern void upload_p256_point_on_curve_constant(uint64_t *x0);
...
static bool isPointOnCurve(uint64_t *p)
{
...
bool Hacl_Impl_ECDSA_P256SHA256_Verification_isCoordinateValid(uint64_t *p)
{
  ...
  uint64_t carryX = Hacl_Impl_LowLevel_sub4_il(x, Hacl_Impl_LowLevel_prime_buffer, tempBuffer);
  uint64_t carryY = Hacl_Impl_LowLevel_sub4_il(y, Hacl_Impl_LowLevel_prime_buffer, tempBuffer);
  uint64_t carryZ = Hacl_Impl_LowLevel_sub4_il(z, Hacl_Impl_LowLevel_prime_buffer, tempBuffer);
